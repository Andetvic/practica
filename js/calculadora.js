$(function(){
  ...
  function cubo() {
    $('#pantalla').val(Math.pow(eval($('#pantalla').val()),3));
  }
  ...
  function amemoria() {
    $('#dato').val($('#pantalla').val());
  }

  function dmemoria() {
    $('#pantalla').val($('#pantalla').val()+$('#dato').val());
    $('#dato').val("");
  }
  ...
  $('#amemoria').on('click',function() {
    amemoria();
  });
  $('#dmemoria').on('click',function() {
    dmemoria();
  });
